        ...
        <div className="container m-auto px-6 py-20 md:px-12 lg:px-20">
          <div className="m-auto text-center lg:w-8/12 xl:w-7/12">
            <h2 className="text-2xl text-pink-900 font-bold md:text-4xl">
              A Coupon Code will gives you discount to our brand products
              and more.
            </h2>
          </div>
              ...
              <div className="relative p-6 pt-16 md:p-8 md:pl-12 md:rounded-r-2xl lg:pl-20 lg:p-16">
                <ul role="list" className="space-y-4 py-6 text-gray-600">
                  <li className="space-x-2">
                    ...
                    <span>Introduce a special promotion: Get a Glam Makeover!</span>
                  </li>
                  <li className="space-x-2">
                    <span className="text-purple-500 font-semibold">
                      
                    </span>
                    <span>Explore our premium beauty products for radiant results.</span>
                  </li>
                  <li className="space-x-2">
                    <span className="text-purple-500 font-semibold">
                      
                    </span>
                    <span>Discover Beauty Perfection</span>
                  </li>
                  <li className="space-x-2">
                    <span className="text-purple-500 font-semibold">
                      
                    </span>
                    <span>Fourth, access to all brand product weekly discount</span>
                  </li>
                </ul>
